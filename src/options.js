const options = {
  ...
  cuts :{
    ...
    Pork: ["Whole Hog", "Picnic Shoulder", "Boston Butt", "Whole Shoulder", "Spare Ribs", "Baby Back Ribs", "Country Ribs ", "Loin Chop", "Rib Chop", "Loin Roast", "Rib Roast", "Tenderloin", "Belly", "Bacon", "Ham", "Ham Hock"],
...
export const { meats, cuts } = options;